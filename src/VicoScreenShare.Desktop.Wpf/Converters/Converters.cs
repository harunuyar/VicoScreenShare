...
public sealed class ServerStatusToBrushConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        return status switch
        {
            ...
            VicoScreenShare.Client.Services.ServerStatus.AuthRequired => AuthRequired,
            VicoScreenShare.Client.Services.ServerStatus.Offline => Offline,
            _ => Pending,
        };
    }
...
public sealed class ServerStatusToTextConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        {
            VicoScreenShare.Client.Services.ServerStatus.Online => "Online",
            VicoScreenShare.Client.Services.ServerStatus.AuthRequired => "Password required",
            VicoScreenShare.Client.Services.ServerStatus.Offline => "Offline",
            VicoScreenShare.Client.Services.ServerStatus.Checking => "Checking…",
            _ => "—",
        };
    }
